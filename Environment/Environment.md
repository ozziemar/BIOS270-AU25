...
So I realized I made the .py file within the Environments folder so it worked, but if I would have made it in $SCRATCH I would have had to done -B $SCRATCH.
